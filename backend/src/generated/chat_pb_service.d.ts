...
export class ChatServiceClient {
  ...
  getConnections(
    ...
    callback: (
      ...
      responseMessage: chat_pb.ConnectionsResponse | null,
    ) => void,
  ): UnaryResponse
  getConnections(
    requestMessage: chat_pb.ConnectRequest,
  ...
  getConnectionStream(
    requestMessage: chat_pb.ConnectRequest,
    metadata?: grpc.Metadata,
  ): ResponseStream<chat_pb.ConnectionsStreamResponse>
  getChatStream(
    requestMessage: chat_pb.ConnectRequest,
    metadata?: grpc.Metadata,
  ): ResponseStream<chat_pb.ChatStreamResponse>
  updateChannel(
    requestMessage: chat_pb.Message,
    metadata: grpc.Metadata,
    callback: (
      error: ServiceError | null,
      responseMessage: api_pb.StatusResponse | null,
    ) => void,
  ): UnaryResponse
  updateChannel(
    requestMessage: chat_pb.Message,
